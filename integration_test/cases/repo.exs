...
defmodule Ecto.Integration.RepoTest do
  ...
  describe "upsert via insert" do
    ...
    test "on conflict keyword list" do
      ...
      # testing autogenerated uuid isn't removed when it's present in query
      assert updated.uuid == "6fa459ea-ee8a-3ca4-894e-db77e160355e"
      # testing autogenerated inserted_at is nil when not specified
      assert updated.inserted_at == nil
      assert TestRepo.get!(Post, inserted.id).inserted_at != nil
    end
    ...
    test "on conflict keyword list and conflict target and returning" do
      ...
      # testing autogenerated is nil when not in returning
      assert c4.uuid == nil
    end
